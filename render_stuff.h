...
void drawWater(Material waterMaterial, const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix,
	skyboxFarPlaneShaderProgram& waterShader, MeshGeometry** geometry, GameUniformVariables gameUni);
